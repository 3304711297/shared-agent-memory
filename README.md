...
| 分支 | 内容 | 物理位置 |
|------|------|----------|
| `main`（默认） | **双端共享记忆库**（唯一真源）：`projects/default-*/memory/*.md` 专题记忆 + `MEMORY.md` 索引 | `C:\Users\<username>\.zcode\cli\memories\` |
...
cmd /c mklink /J "%LOCALAPPDATA%\hermes\memories\topics" "C:\Users\<username>\.zcode\cli\memories\projects\default-135ef1b9f66d8a7e\memory"
```
