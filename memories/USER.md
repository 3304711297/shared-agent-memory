...
- 用户个人 Telegram 频道：拥有并运营 Telegram 频道 @emoegg（https://t.me/emoegg，Web 预览 https://t.me/s/emoegg，曾用名/副标题「某不知名杂货铺」），专注于网络代理协议解析、延迟/RTT 测评、TUN 协议栈、GFW/地方防火墙机制研究及实用软件定制资源。
§
