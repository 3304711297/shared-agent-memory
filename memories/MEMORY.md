...
§
WorkBuddy=本地 codebuddy2openai 反代 http://127.0.0.1:8787/v1（Tauri v2 客户端：多账号/积分看板/托盘/Hermes 一键写入）；venv=C:\Users\<username>\.workbuddy\binaries\python\envs\default；运维细节检索 OpenViking。
§
