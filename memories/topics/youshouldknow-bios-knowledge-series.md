...
- **最新同步点**：ysk `d0fc852`，tweak 已闭环同步，CI 全绿、线上 Pages 已含新页面。
...
- **重制版 EP15 收录**：2026-09-03 收录重制版 EP15 《NVMe识别全链路与故障排查.md》（BV1BdtX6XEdu，15:22），提出五层诊断模型、两条总闸铁律及 0x7B 安全模式恢复法，并更新系列总览与导航（close #9）。
- **新增内容**：docs/BIOS与固件/ 下 20 篇系列文章（总览+入门3篇+安全2篇+硬件选项各篇含 EP15 NVMe+CPU 系列5篇）+ docs/内存超频/XMP-EXPO内存认证档科普.md；mkdocs.yml nav、两分类 README、根 README 全景表同步。每篇底部附视频出处链接。
