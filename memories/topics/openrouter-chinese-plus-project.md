...
桌面 `C:\Users\<username>\Desktop\openrouter-chinese\` 是三源合并的油猴脚本项目（2026-08-21 创建），发布目标为 GitHub 仓库 **3304711297/openrouter-chinese-plus**（gh CLI 登录账号 `3304711297`，昵称"智商已更新"）。
