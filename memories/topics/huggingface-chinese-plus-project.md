...
桌面 `C:\Users\<username>\Desktop\huggingface-chinese\` 是 Hugging Face 中文化油猴脚本项目（2026-08-29 创建），发布仓库 **3304711297/huggingface-chinese-plus**（gh 账号 3304711297），初始提交 `faf7249`，产物 `huggingface-chinese-plus.user.js` v1.0.1。
