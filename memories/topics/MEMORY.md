...
- [User Windows Environment](user-windows-environment.md) — Windows 环境：本地代理 127.0.0.1:3067、gh 账号 3304711297、PS 5.1/7 双版本规则、浏览器是 Edge Dev、EasyCLIProxyAPI 官方网关(18080端口，Gemini 3.8/3.7主控+ZCode双端接入已打通)、Google 配额监控微服务(18088端口)
