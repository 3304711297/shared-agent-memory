...
- **ZCode 配置**：`~/.zcode/cli/config.json` → `mcp.servers["chrome-devtools"]` = `npx -y chrome-devtools-mcp@1.7.0 --autoConnect --user-data-dir=C:\Users\<username>\AppData\Local\Microsoft\Edge Dev\User Data`。
