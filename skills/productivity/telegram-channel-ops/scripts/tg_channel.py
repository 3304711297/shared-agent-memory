"""Telegram Channel Management CLI & Helper.

Reads configuration from auth/telegram_channel.json or environment variables,
and routes through the configured HTTP proxy.
"""
