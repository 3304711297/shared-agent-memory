...
- 根目录：`C:\Users\<username>\.zcode\cli\memories\projects\default-135ef1b9f66d8a7e\memory\`
...
4. **【铁律】修改或新增记忆后自动推送 GitHub**：
   ...
   ```bash
   git -C "C:/Users/<username>/.zcode/cli/memories" -c http.proxy=http://127.0.0.1:3067 add . && git -C "C:/Users/<username>/.zcode/cli/memories" commit -m "docs(memory): <简短说明>" && git -C "C:/Users/<username>/.zcode/cli/memories" -c http.proxy=http://127.0.0.1:3067 push origin zcode
   ```
