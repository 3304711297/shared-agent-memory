...
python C:/Users/<username>/AppData/Local/hermes/scripts/search_bookmarks.py "<关键词>" -n 20

# 按文件夹过滤搜索
python C:/Users/<username>/AppData/Local/hermes/scripts/search_bookmarks.py "<关键词>" -f "AI" -n 10

# 查看主要分类文件夹分布
python C:/Users/<username>/AppData/Local/hermes/scripts/search_bookmarks.py --folders
```
