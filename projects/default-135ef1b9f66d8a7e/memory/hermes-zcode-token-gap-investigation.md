...
- Hermes 会话库：`C:/Users/<username>/AppData/Local/hermes/state.db`（session_model_usage 表 task='background_review' 单独记账）
- ZCode 会话库：`C:/Users/<username>/.zcode/cli/db/db.sqlite`（model_usage 表，只读用 uri=file:...?mode=ro）
