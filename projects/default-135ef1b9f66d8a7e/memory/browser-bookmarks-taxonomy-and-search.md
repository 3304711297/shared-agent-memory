...
```bash
# 模糊匹配标题、URL 或目录路径
python C:/Users/<username>/AppData/Local/hermes/scripts/search_bookmarks.py "<检索词>" -n 20

# 限定在特定分类目录搜索
python C:/Users/<username>/AppData/Local/hermes/scripts/search_bookmarks.py "<检索词>" -f "AI" -n 10
```
