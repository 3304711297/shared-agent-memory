...
- [Skill Plugin Resources](skill-plugin-resources.md) — **新技能发现索引库（唯一入口）**：18 个源约 1467 个可拉取技能（ECC 898/hermes-agent 199/knowledge-work-plugins 212/science-skills 40/mattpocock 37 等）；1-13=发现新技能按需检索，14-18=已装技能溯源重装（superpowers/ponytail/hermes-agent/BadTechBandit/blogwatcher-cli）；2026-09-09 起**不再作为 CI 技能雷达**，看门不再发现新技能
