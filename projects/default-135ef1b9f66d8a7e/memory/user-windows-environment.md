...
- 桥接进程：`cli-proxy-api.exe`，本地监听 `http://127.0.0.1:18080`，配置文件位于 `C:\Users\<username>\AppData\Local\ZCodeAntigravity\config.yaml`（API key 在 `api-keys:` 列表）
...
- **用户全局 Skills**（位于 `C:\Users\<username>\.zcode\skills\`）：
