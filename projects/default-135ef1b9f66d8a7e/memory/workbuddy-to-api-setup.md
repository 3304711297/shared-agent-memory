...
- **代码目录**：`C:\Users\<username>\AppData\Local\hermes\codebuddy2openai`
...
- **启动脚本**：
  - 后台静默启动：`C:\Users\<username>\AppData\Local\hermes\codebuddy2openai\start_silent.vbs`
  - 终端运行脚本：`C:\Users\<username>\AppData\Local\hermes\codebuddy2openai\start_workbuddy_proxy.bat`
- **Hermes 接入状态**：
