...
文件路径：`C:\Users\VOS-User\AppData\Local\hermes\config.yaml`
...
- **How to apply**: 当用户提及「我改了设置 / 看一下我改的 / 同步一下设置」时，立即执行 `read_file(C:/Users/VOS-User/AppData/Local/hermes/config.yaml)`，对比变动点后覆写更新本文件并提交推送 `main`。
