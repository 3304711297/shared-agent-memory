...
2. **共享记忆物理真源贯通**：
   - 针对各 Profile 隔离目录（`AppData\Local\hermes\profiles\<name>\memories\topics`），全部建立 NTFS Junction 软链接，直通 `C:\Users\<username>\.zcode\cli\memories\projects\default-135ef1b9f66d8a7e\memory\`；
