...
**工程化**：拆 main.js(1047行,15处innerHTML,4个window全局)与 commands.rs(1165行,4处硬编码C:\Users\<username>残留)、测试(上游 *_at(root) 参数化模式+12测试文件，本地零测试)、CI 加 cargo test/pytest、requirements.txt 缺失、CSP null。
