...
| Cangjie 仓颉内容方法论蒸馏技能 | `cangjie-distill` | 2.5.0 | ✅ 最新 |
| OpenViking 上下文记忆与语义检索数据库 | `openviking` | 0.4.18 | ✅ 最新 |
...
- 本地清单：`C:/Users/<username>/.zcode/cli/plugins/marketplaces/zcode-plugins-official/marketplace.json`
...
- 上游最新：**c11753d0**（2026-09-07）fix(skills): replace invented autonomous harness setup instr
- 基线：`c11753d0` → ✅ 一致

### Hermes 官网 Skills Hub 全网技能索引（hermes-skills-hub）

- 上游最新：**90,698** 技能（索引时间：`2026-09-08`，自营: 197, 外部: 90501）
...
- 配置文件：`C:/Users/<username>/AppData/Local/hermes/config.yaml`
...
- ✅ `C:/Users/<username>/AppData/Local/hermes/hermes-agent` 无 stash 残留
- ✅ `C:/Users/<username>/AppData/Local/hermes` 无 stash 残留
...
- 上游最新：**2.5.0**
- `Hermes skills/productivity/cangjie-distill + ZCode ~/.zcode/skills/cangjie-distill`：已装 **2.5.0** → ✅ 一致

### OpenViking 上下文记忆与语义检索数据库（openviking）

- 上游最新：**0.4.18**
- `本地专属环境 C:/Users/<username>/.openviking/venv`：已装 **0.4.18** → ✅ 一致
